...
def vragen():
  ...
  if b == "Ja" or b == "ja": 
    print("Je staat in de modder, met een grote heuvel voor je en een enorme schaduw hangt over je heen.") 
    print("Je denkt al jaren aan die ene legende die je toen hoorde van je opa.") 
    print("Eindelijk heb je je ouders kunnen overtuigen om je op reis te laten gaan en je gaat op zoek naar de schat waar je opa je zoveel verhalen over had verteld.")
    print("De schat ligt op de berg.") 
    print("Je staat hier voor je eerste kruising, welk pad zal je kiezen?")
  elif b == "Nee" or b == "nee":
