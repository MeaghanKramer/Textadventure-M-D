kamers = {
  ...
  "klimmen": {
    ...
    "beschrijving": "Je probeert over de muur te klimmen maar het lukt niet. Na talloze pogingen raak je moe en eindigt daar je reis op zoek naar de schat.",
    "options": [],
    "lost": "ja",
    "win": "nee",
    },
  ...
  "grot in": {
    ...
    "beschrijving": "Je kiest ervoor de grot in te gaan. Je ziet de schat voor je liggen en weet dat je het onmogeljke hebt behaald. Je hebt de schat gevonden! Je leeft verder een prachtig leven",
    "options": [],
    "lost": "nee",
    "win": "ja",
    },
  "grot niet in": {
    ...
    "beschrijving": "Je doet een stap naar achter om de grot nog eens goed te bekijken. Je voet slipt weg en je valt een langzame dood tegemoet aan het einde van de berg. Je was zo dichtbij maar toch zo ver weg.",
    "options": [],
    "lost": "ja",
    "win": "nee",
    },
